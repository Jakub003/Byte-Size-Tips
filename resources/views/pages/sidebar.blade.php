<div class="flex flex-col space-y-6 overflow-y-auto">
    <div class="flex flex-col space-y-1.5">
        ...
        <x-button.menu-item name="Database Migrations" />
        <x-button.menu-item name="Factory Seeders" />
        <x-button.menu-item name="Eloquent Queries" />
        <x-button.menu-item name="Blade Components" />
        <x-button.menu-item name="Livewire Components" />
        <x-button.menu-item name="UI/UX Resources" />
    </div>
    ...
    <div class="flex flex-col space-y-1.5">
        ...
        <x-button.menu-item name="Markdown Editor" />
        <x-button.menu-item name="Notifications" />
    </div>
    <div class="flex flex-col space-y-1.5">
    ...
    <div class="flex flex-col space-y-1.5">
        ...
        <x-button.menu-item name="Overview" />
